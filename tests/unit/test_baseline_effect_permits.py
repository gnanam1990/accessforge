...
from accessforge_persistence import baseline_effects as permits
from accessforge_persistence import baseline_observations, supervisor_sessions
...
class Store:
    ...
    def execute(self, query: str, args: Any = ()) -> Cursor:
        ...
        if query.startswith("SELECT * FROM baseline_action_effect_permit"):
        ...
        assert query.startswith("INSERT INTO baseline_action_effect_permit")
        self.stored = dict(
            zip(
                (
                    "id",
