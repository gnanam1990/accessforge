...
Still pending: operator command/host provisioning and browser request form; provider consumption
reconciliation; actual retained source/model/reader acceptance and remaining repair/release work.
