...
| 22 | Projects, journeys and runner UI | 19, 21 | FR-001–005, 015, 017, 019 | implemented (5 screens; no events or schedules UI) | **blocked — no sealed manifest can be recorded, so no run can be requested** | open | E0 |
