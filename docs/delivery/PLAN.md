...
| 26 | Security, privacy, metering and operations | 17, 19, 25 | FR-014, 015, 019–021, 025 | implemented (entitlements, metering, retention, settings, probes, scoped deletion with an honest report; no telemetry or rate limits) | passed for what is enforced; **no external penetration test** | merged | R1 |
