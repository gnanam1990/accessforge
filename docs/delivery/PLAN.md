...
| 23 | Run and evidence replay UI | 10, 11, 19, 21 | FR-006, 007, 009, 015, 017, 019 | implemented (run, timeline, finding; no SSE, no media) | **blocked — no per-assertion results are served, and no run has executed** | open | E0 |
