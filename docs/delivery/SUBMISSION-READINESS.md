...
- [ ] Record real human review and independently verify exported evidence bundle.
- [ ] Rehearse setup and connected workflow without hidden SQL changes.

Missing evidence is not PASS. Timeout is not STOP. Synthetic development evidence must never
be presented as the actual working reader demonstration.
